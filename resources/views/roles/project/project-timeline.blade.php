                ...
                <div class="card-body ">
                    <div class="timeline">
                        ...
                        <header class="t_card__header">
                                    ...
                                    <h4 class="t_card__title r-title">Project assigned {{$stages->firstWhere('id', $event->stage->project_stage_id)->project_stage}}</h4>
                                </header>
                        ...
                        <div class="timeline__card t_card call">
                                <header class="t_card__header">
                                    ...
                                    <h4 class="t_card__title r-title">{{$calls->firstWhere('id', $event->callSignUps[0]->call_id)->title}}</h4>
                                </header>
                                <div class="t_card__content">
                                    <p>{{$calls->firstWhere('id', $event->callSignUps[0]->call_id)->description}}</p>
                                            ...
                                            <div class="card-header" id="heading_{{$signUp->id}}">
                                                <h2 class="mb-0">
                                                    <button class="btn btn-link btn-block text-left" type="button"
                                                       ...
                                                       Sign up report: {{$users->firstWhere('id', $signUp->user_id)->name.' '.$users->firstWhere('id', $signUp->user_id)->surname}}
                                                    </button>
                                                </h2>
                                            </div>

                                            <div id="collapse_{{$signUp->id}}" class="collapse" aria-labelledby="heading_{{$signUp->id}}"
                        ...
                        <div class="timeline__card t_card task">
                                <header class="t_card__header">
                                    ...
                                    <h3 class="t_card__title r-title">{{$event->task->title}}</h3>
                                </header>
                                <div class="t_card__content">
