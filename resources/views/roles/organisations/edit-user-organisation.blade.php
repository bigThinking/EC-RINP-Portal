                            ...
                            <div class="card-body ">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <textarea rows = "5" cols = "130" name = "description" id="description" value="{{$user->organisation->description}}" placeholder="Description">{{$user->organisation->description}}</textarea><br>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
