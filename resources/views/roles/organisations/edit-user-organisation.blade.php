...
@section('content')
    ...
    <div class="content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form id="edit-role" method="post" action="{{ route('update-user-organisation',$user->id) }}" class="form-horizontal" >
                        @csrf
                        @method('put')
                        <div class="card ">
                            ...
                            <div class="card-body ">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <input name="organisation_name" type="text" id="organisation_name" value="{{$user->organisation->organisation_name}}" class="form-control"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <textarea  class="form-control" rows = "5" cols = "130" name = "description" id="description" value="{{$user->organisation->description}}" placeholder="Description">{{$user->organisation->description}}</textarea><br>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <input name="reg_no" type="text" id="reg_no" value="{{$user->organisation->reg_no}}" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col">
                                        <input name="location" type="text" id="location" value="{{$user->organisation->location}}" class="form-control"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <input name="email" type="text" id="email" value="{{$user->organisation->email}}" class="form-control"
                                                   placeholder="Email">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <input name="website" type="text" id="website" value="{{$user->organisation->website}}" class="form-control"
                                                   placeholder="Website">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <input name="contact_number" type="text" id="contact_number" value="{{$user->organisation->contact_number}}" class="form-control"
